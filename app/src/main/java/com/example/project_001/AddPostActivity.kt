...
class AddPostActivity : AppCompatActivity() {
    ...
    private fun uploadImage() {
        when{
            ...
            TextUtils.isEmpty(findViewById<TextView>(R.id.descripton_post).text.toString()) -> {
                Toast.makeText(this, "Please write description first", Toast.LENGTH_LONG)
            }
            else -> {
                ...
                uploadTask.continueWithTask(Continuation<UploadTask.TaskSnapshot, Task<Uri>> { task ->
                    ...
                    .addOnCompleteListener ( OnCompleteListener<Uri>{task ->
                        if (task.isSuccessful){
                            ...
                            postMap["description"] = findViewById<TextView>(R.id.descripton_post).text.toString().toLowerCase()
